    ...
    <div class="grid grid-2">
      ...
      <figure class="card">
        <div class="thumb">
          ...
          <img src="<c:url value='/photos/rooms/room-option-${prefix}.jpg'/>"
               alt="${summary.roomTypeName}" />
        </div>
...
(function() {
  function init() {
    ...
    if (params.get("status") === "cancelled") {
      ...
      if (id) msg.textContent = "Your reservation #" + id + " has been cancelled.";
      ...
      document.getElementById("closeCancel").onclick = close;
      document.getElementById("cancelBackdrop").onclick = close;
